      ...
      <div className="container grid md:grid-cols-2 gap-10 items-center py-16 md:py-24">
        <div className="space-y-6 animate-enter">
          <p className="inline-flex items-center rounded-full bg-secondary px-3 py-1 text-xs font-medium text-secondary-foreground">
            Trusted IT Onsite Services
          </p>
          <h1 className="text-4xl md:text-5xl font-extrabold leading-tight">
            Fixtech Services — Onsite IT, Deployments & Managed Support
          </h1>
          <p className="text-lg text-muted-foreground max-w-prose">
            From multi-site rollouts to urgent break/fix support. We deliver
            reliable engineers, clear SLAs, and enterprise-grade results.
          </p>
        ...
        <div className="relative">
          <img
            src={heroThree}
            alt="Abstract technology background for Fixtech Services"
            className="rounded-xl border shadow-elegant w-full object-cover"
            loading="lazy"
          />
          <div
